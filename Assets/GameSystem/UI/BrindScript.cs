    ...
    private void HandleEnergyLevels() // エネルギー管理
    {
        if (gameManagerScript.IsGameStart())
        {
            ...
            if (playerModelsScript.IsIndex() == 0)
            {
                ...
                if (energyManagerScript.GetBatteryEnergy() >= 40 && !hasPowerUpImageBeenHidden)
                {
            ...
            if (playerModelsScript.IsIndex() == 1)
            {
                ...
                if (energyManagerScript.GetBatteryEnergy() >= 45 && !hasPowerUpImageBeenHidden)
                {
            ...
            if (playerModelsScript.IsIndex() == 2)
            {
                ...
                if (energyManagerScript.GetBatteryEnergy() >= 50 && !hasPowerUpImageBeenHidden)
                {
